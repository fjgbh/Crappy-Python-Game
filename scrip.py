...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("C:/Users/bmsac/Downloads/Scrip files/Ship.png").convert_alpha()
...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("C:/Users/bmsac/Downloads/Scrip files/Enemy ship.png").convert_alpha()
        self.rect = self.image.get_rect()
...
while avariable == True:
    ...
    if game_state == "start_menu":
        ...
        pygame.mixer.music.load("C:/Users/bmsac/Downloads/Scrip files/Happy music.wav")
            ...
            for event in pygame.event.get():
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_q:
                        ...
                        exit()
    # Draw / render
    imp = pygame.image.load("C:/Users/bmsac/Downloads/shutterstock-540775171___01150021748.png").convert()
